...
def main():
    ...
    #
    #execution_time_report("quick_sort, cutoff=0",
         #sort.quick_sort, cutoff = 0, shuffle_array = False, use_median_of_three = False)
    #execution_time_report("quick_sort, cutoff=0, shuffle",
         #sort.quick_sort, cutoff = 0, shuffle_array = True, use_median_of_three = False)
    execution_time_report("quick_sort, cutoff=0, median of three",
         sort.quick_sort, cutoff = 0, shuffle_array = False, use_median_of_three = True)
    execution_time_report("quick_sort, cutoff=40, median of three",
         sort.quick_sort, cutoff = 40, shuffle_array = False, use_median_of_three = True)
    execution_time_report("quick_sort, cutoff=50, median of three",
         sort.quick_sort, cutoff = 50, shuffle_array = False, use_median_of_three = True)
    execution_time_report("quick_sort, cutoff=60, median of three",
         sort.quick_sort, cutoff = 60, shuffle_array = False, use_median_of_three = True)
    execution_time_report("quick_sort, cutoff=70, median of three",
         sort.quick_sort, cutoff = 70, shuffle_array = False, use_median_of_three = True)
    #execution_time_report("quick_sort, cutoff=0, shuffle, median of three",
         #sort.quick_sort, cutoff = 0, shuffle_array = True, use_median_of_three = True)
...
sample_sizes = [10, 30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 300, 500, 1000, 10000]
