...
def quick_sort(array, cutoff = 100, use_median_of_three = True, shuffle_array = True):
...
def partition(array, lo, hi, use_median_of_three):
    ...
    if use_median_of_three:
        ...
        # nearest integer.
        #i, j, k = lo, len(array[lo:hi])//2, hi-1
        x = median_of_three(array, lo, (lo+hi)//2, hi-1)
        
        array[lo], array[x] = array[x], array[lo]
